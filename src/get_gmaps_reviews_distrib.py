...
def get_gmaps_reviews_distrib(screenshot_fpath: str):
    ...
    response = llm.invoke([SystemMessage(BARCHART_SYSTEM_PROMPT), message])
...
if __name__ == '__main__':
    get_gmaps_reviews_distrib(sys.argv[1])
